---
title: "Receiving Calls with SalesCaptain"
...
<Info>
  **_<Tooltip tip="">Tip</Tooltip>:_**_ Set up time-based routing so calls after hours are handled by voicemail or AI, ensuring no lead slips through the cracks._
</Info>